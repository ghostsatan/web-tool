 ...
 * http://blog.csdn.net/zh921112/article/details/41513161 ql 添加 基本配置
 */
!
function (a, b) {
    "use strict";
    ...
    function h(a) {
        ...
        g(c, function (a, e, f) {
            ...
            e.label || (e.label = a),
            e.className || (e.className = 2 >= d && f === d - 1 ? "combtn-big" : "combtn-cancel-big")
        }),
        a
    }
    function i(a, b) {
    ...
    var n = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div style='height:40px;line-height:40px;text-indent:20px;background:#058be9;color:white;font-size:16px;font-weight:bold;'>提示信息</div><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
        header: "<div class='modal-header'><h4 class='modal-title'></h4></div>",
        footer: "<div class='modal-footer'></div>",
        closeButton: "<button type='button'  class='bootbox-close-button close' data-dismiss='modal' style='' aria-hidden='true'>&times;</button>",
    ...
    p.dialog = function (a) {
        ...
        if (g(j, function (a, b) {
                k += "<button data-bb-handler='" + a + "' type='button' class=' " + b.className + "'>" + b.label + "</button>",
                l[a] = b.callback
            ...
            a.title ? d.find(".modal-header").prepend(m) : m.css("margin-top", "-45px").prependTo(i)
        }
